...
class MailList extends Component {
    ...
    mailList: [
      {
        ...
        friends: [
          {
            id: 1,
            avatar: 'https://dss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=443801258,2722780474&fm=111&gp=0.jpg',
            username: '熊熊熊',
          },
          {
            id: 2,
  ...
  toSingleChat = (id) => {
    this.props.history.push('/singlechat', { name: '虎虎虎', id: id })
  }
  render() {
              ...
              this.state.mailList.map(item => (
                <div className="name-item" key={item.label} data-index={item.label}>
                  ...
                  <div className="name-list">
                    {
                      item.friends.map(it => (
                        <div className="list-item" key={it.id} onClick={this.toSingleChat.bind(this, it.id)}>
                          <div className="avatar">
                            <img src={it.avatar} alt="" />
                          </div>
                          <div className="username">{it.username}</div>
                        </div>
                      ))
                    }
